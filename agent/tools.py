...
_GZHANSTONG_TM = [
    ...
    ROOT / "data/processed/tm_gzhanstong_58.jsonl",        # 品五（根本分别·十种[虚妄]分别·遍计无边·1摄颂+疏·《摄论》十散动他空统摄四类[假立分皆遍计]:根本分别=阿赖耶识/相分别mtshan ma执六尘所取+显现相分别mtshan snang根识能取+变相分别mtshan 'gyur受相变→总摄显现相变snang 'gyur/不如理分别[闻非法·外道我执]+如理分别[闻善说·无常苦空无我·然假立分仍属遍计]→总摄他引分别gzhan bstan/执著分别mngon zhen=外道六十二恶见lta ba 'thib po见稠林·分类无边→遍计无边·「十」忠实沿用摄论十种[用户夹注+摄论原文证,收回疑九];含汉传暗引:大乘庄严经论世亲释十分别对治/摄大乘论十散动;止于遍计无边·后十一识唯识无外境段待回流）
