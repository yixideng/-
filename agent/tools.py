...
_GZHANSTONG_TM = [
    ...
    ROOT / "data/processed/tm_gzhanstong_515.jsonl",       # 品五（具关联十二支广说·无明支/行支[11段含辨中边论十二支性相根颂]:①辨中边论根颂[无明遮蔽/行播植/识导引/名色遍持/入圆满/触三决定/受受用/爱摄受/取结合/有现前/老死苦·三杂染=烦恼(无明爱取)+业(行有)+苦(余七)从虚妄分别起]②无明支三特征[缘自境/境相极不明/令心不寂静烦恼门]③avidyā词源[vidyā明觉+a遮遣·七否定义·取明觉之相违异法]④无明二分[具烦恼无明=烦恼障轮回因/非具烦恼无明=所知障]⑤辩破执实=具烦恼无明[否则执瓶为瓶/一切取相作意皆成太过·具烦恼无明特指缘我而愚非泛指取相]⑥根本无明=末那我痴(内观不直接生业)/意识我痴=生贪嗔痴积不善业者⑦善业无明支义[善法从三无(无贪无嗔无痴=三善根)生·意识我痴伴我爱→自爱→三善根造善行·彼时等起=三善根近因/因位等起=无明远因加持·故皆名无明支]⑧辩破无明=萨迦耶见[若一则十烦恼/六根本烦恼数不全·萨迦耶见与无明相属相显明故举以代表显相]⑨行支三业[福=欲界善/非福=欲界不善/不动=感上二界色无色·等引三摩地·异熟不转他处·福非福业中有位可缘转];术语:རིག་པ明觉/具烦恼之无明/我痴我爱自爱/三无=三善根/ཀུན་སློང因位等起(远因)彼时等起(近因)/加持/不动业/等引三摩地;含汉传:辨中边论玄奘译对照+十根本烦恼五钝五利+六根本烦恼补注;句法:ཁྱོད→ཁྱད讹字·因位等起判支·教证补注不入平行文）
    ROOT / "data/processed/tm_gzhanstong_517.jsonl",       # 品五（文义门[承5.15-16总义门]·释弥勒《辨中边论》十一门[15段→7对;含世亲二根颂在516]:①十一种差别之门[དབྱེ་བ་བཅུ་གཅིག=十一门非支数·非「一支」]②具身有情无明障实相正智[ཡང་དག་པའི་ཡེ་ཤེས=圣者菩萨等持智·清净后得摄之·闻思修无倒三慧=随顺正智]③行支[施植福/非福/不动六趣习气种子]④识支因果二识[因识=行缘识·行熏植种识转变分/果识=引至生处·识缘名色·名色由此生]⑤应成难摄十一支[设难:因识生果识生名色岂非成十二支(应成过)?答:因果二识相/事业/种类相似故摄入十一支中·བཅུ་གཅིག=十一(我前误「摄为一支」订正)]⑥名色支同分身[རིགས་མཐུན=同分nikāyasabhāga·执持此生同分身之最初];术语:因识/果识·十一种差别之门·同分(众同分)·具身有情·正智=等持智;校勘:རིག→རིགས讹字·རྐྱཻན衍生元音径读རྐྱེན;句法§28:数词严校(十一/十二/支数vs门数·应成过之数勿当定说)·因果识构词随文;含汉传:安慧辨中边论释同分/无著集论摄受因）
    ROOT / "data/processed/tm_gzhanstong_516.jsonl",       # 品五（十二支别释·识支至老死[15段含世亲末二根颂]:识支因果位识[因位识=仅安置业种子识转变分/果位识=业力增长引至生处]·名色支四名蕴[名=受想行识后四蕴·色蕴现量五根识行境不待名知/后四蕴他相续存须依名(言说)知]·名色支现行=阿赖耶结生相续入胎[入父母精血聚·色蕴=大种造果色·受想行=五遍行内类·识蕴=阿赖耶·此位无意识:意识须意根先·意根须五根识灭先·六处未现→五根识不生(根为识依·方向订正)]·胎中五位[ནུར་ནུར羯罗蓝→མེར་མེར頞部昙→གོར་གོར閉尸→འཁྲང་གྱུར鍵南→རྐང་ལག鉢罗奢佉]·六处·触[境根识三合]·受·十八意近行[6境×3受=18]·三爱[欲爱/有爱/离有爱(坏爱vibhava);第三支阿毗达磨作欲舍诸蕴/法称作摄受受用·本论取法称;名实张力化解:离有爱=求离肉身仍含我执摄受面]·四取[欲/戒禁/见/我语取]·有[能成办后有业力]·生支[正结生相续者]/老死支[结生已毕·羯罗蓝起刹那相续变=老·老死合一支未老而死亦有]·二种生起[种子位未现/种子成熟现前]·世亲十二支摄七义根颂[能引2/如何引1/所引4/能成办2/有1/所成生1/老死1];校勘:入母胎结生→入母胎结生相续·胎中五位定名与4.8冲突(ནུར/མེར二读并存据上下文定·5.16定谳不覆4.8)·因位识因时识並存;含汉传补注:manopavicāra十八意近行/四取释）
